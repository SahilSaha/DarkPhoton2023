...
ma.applyCuts('ap:mumu','theta < 2.9',path=mypath)
...
ma.applyCuts('vpho:Total','chiProb >0',path=mypath)
...
basevars = ['theta','cosTheta','phi']+vc.inv_mass + vc.kinematics + vc.vertex + vc.track + vc.mc_truth + cmsvars 
